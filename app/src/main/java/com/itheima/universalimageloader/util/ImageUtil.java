package com.itheima.universalimageloader.util;
...
public class ImageUtil {
    ...
    public static HashMap<Integer, CheckBoxStatus> getMediaImage(Context context) {
        HashMap<Integer, CheckBoxStatus> datas = new HashMap<Integer, CheckBoxStatus>();
        ...
        if(cursor != null){
            ...
            while (cursor.moveToNext()){
                ...
                CheckBoxStatus galleryModel = new CheckBoxStatus("file:/" + path, false);
                datas.put(index, galleryModel);
                index ++;
            }
     ...
     * @return
     */
    public static HashMap<Integer, CheckBoxStatus> getHttpImage(Context context) {
        ...
        for (int i = 0; i < imageUrls.length; i++) {
            datas.put(i, new CheckBoxStatus(imageUrls[i], false));
        }
        return datas;
    }
}
